<script setup>
import SidebarVue from '../Components-ISRI/Sidebar.vue';
import HeaderVue from '../Components-ISRI/Headerisri.vue';
</script>
            ...
            <div class="w-full bg-slate-50">
                <section class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-4 py-12">
                    ...
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4">
                        ...
                        <!-- 1 card -->
                        <a href="/dashboard"
                            class="relative cursor-pointer py-6 px-6 rounded-3xl w-64 my-4  bg-white  shadow-lg hover:scale-110 transform transition-all duration-500 hover:shadow-red-700">
                            <div
                            ...
                            <div class="mt-8">
                                <p class="text-xl font-semibold my-2">System's name</p>
